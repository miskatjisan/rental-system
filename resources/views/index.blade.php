		...
		<div class="container" style="background-color: black">
			<form class="filter-form" action="{{route('search_property')}}" method="post">
				...
				<select name="state">
					...
					<option value="Sindh">Baridhara</option>
					<option value="Kpk">Gulshan</option>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 blog-item">
					...
					<div class="blog-meta">
						...
						<span><i class="fa fa-clock-o"></i>17 Jan 2023</span>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 footer-widget">
					<div class="contact-widget">
						...
						<p><i class="fa fa-envelope"></i>www.rentalsystem@gmail.com</p>
