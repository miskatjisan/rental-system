...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav" style="background-color: black;"> 
    ...
    <ul>
      ...
      <li class="active"><a href="{{route('advisor_info')}}"><i class="fa fa-info"></i> Landlord Info</a></li>
      <li ><a href="{{route('advisor_upgrade')}}"><i class="fa fa-thumbs-up"></i> Landlord Upgradation</a></li>
...
<table class="table table-dark">
  ...
  @php
    $counter = 0;
  @endphp
  @forelse($data as $advisor)

@php 

$userInfo = DB::table('register_advisors')->where('user_id', $advisor->id)->first();
