...
<body>
				...
				<div class="row">
					...
					<div class="col-lg-6 text-lg-right header-top-right">
						...
						<div class="user-panel">
							...
							$finduser = DB::table('register_tenets')->where('user_id_fk', $data->id)->first();

							@endphp

							<div class="user-panel">
								<a href="#" id="registerbutton"><i class="fa fa-user-circle-o"></i> {{$finduser->first_name}} {{$finduser->last_name}}</a>

								<a href="{{route('tenet_dashboard_view')}}"><i class="fa fa-sign-in"></i> Dashboard</a>
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span><i class="fa fa-angle-right"></i>Houses</span>
		</div>
	</div>
				...
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							@if(\Illuminate\Support\Facades\Auth::check())
							<a href="{{route('paymemt.user',$postdata->id)}}" class="room-price">BDT {{$postdata->rent}}</a>
							@else
							<a href="{{route('login')}}" title="please Register" class="room-price">BDT {{$postdata->rent}}</a>
							@endif
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 footer-widget">
					<div class="contact-widget">
						...
						<p><i class="fa fa-envelope"></i>rentalsystem@gmail.com</p>
		...
		<div class="modal-dialog form-dark" role="document">
			...
			<div class="modal-content card card-image" style="background-image: url('img/login.jpg');">
				<div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
					<!--Header-->
					<div class="modal-header text-center pb-4">
						<h3 class="modal-title w-100 white-text font-weight-bold" id="myModalLabel"><strong>SIGN</strong> <a class="green-text font-weight-bold"><strong> In</strong></a></h3>
						<button type="button" class="close white-text" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
