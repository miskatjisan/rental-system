...
Route::get('post','LinkController@blog')->name('blog');
...
Route::get('post/create','Advisor\AdvisorPostController@postCreate')->name('landlord.post.create');
...
Route::get('AdvisorForm/{id}','PaymentController@PaymentOption')->name('paymemt.user');
Route::post('AdvisorForm','PaymentController@PaymentStore')->name('payment.store');
